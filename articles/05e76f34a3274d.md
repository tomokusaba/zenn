...
📖 **参考ドキュメント:**
- [.NET 9 の ASP.NET Core から .NET 10 の ASP.NET Core に移行する](https://learn.microsoft.com/aspnet/core/migration/90-to-100?view=aspnetcore-10.0&tabs=visual-studio&WT.mc_id=%3Fwt.mc_id%3DDT-MVP-5004827)
- [.NET 10 での破壊的変更](https://learn.microsoft.com/dotnet/core/compatibility/10.0?view=aspnetcore-10.0&WT.mc_id=%3Fwt.mc_id%3DDT-MVP-5004827#aspnet-core)
...
📖 **公式ドキュメント:** [Microsoft Agent Framework](https://learn.microsoft.com/agent-framework/overview/agent-framework-overview?WT.mc_id=%3Fwt.mc_id%3DDT-MVP-5004827)
...
📖 **参考:** [Monitor AI agents with Application Insights](https://learn.microsoft.com/azure/azure-monitor/app/agents-view?WT.mc_id=%3Fwt.mc_id%3DDT-MVP-5004827)
...
:::message
💡 **移行ガイド**: 公式の[Migration Guide from Semantic Kernel](https://learn.microsoft.com/agent-framework/migration-guide/from-semantic-kernel/?WT.mc_id=%3Fwt.mc_id%3DDT-MVP-5004827)を参照
:::

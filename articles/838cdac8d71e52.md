...
### 2. `dotnet` CLI との距離が近い

Copilot CLI は最初からターミナルにいるので、
...
といった**「`dotnet` コマンドが主役」になる作業**と相性が良いです。新機能を入れるときに必要なシェル仕事を、エージェントにまとめて委ねられます。
...
flowchart TB
    ...
    Q1 -- Yes（広い） --> Q2{dotnet コマンドや<br/>スキャフォールドが多い？}
